declare namespace ts {
    ...
    interface TypeChecker {
         ...
         */
        getSuggestionDiagnostics(file: SourceFile): ReadonlyArray<Diagnostic>;
    }
    enum UnionReduction {
        None = 0,
        Literal = 1,
...
declare namespace ts {
    ...
    function getExternalModuleName(node: AnyImportOrReExport | ImportTypeNode): Expression;
    ...
    function getExternalModuleNameFromDeclaration(host: EmitHost, resolver: EmitResolver, declaration: ImportEqualsDeclaration | ImportDeclaration | ExportDeclaration | ModuleDeclaration | ImportTypeNode): string;
    /**
...
declare namespace ts {
    ...
    function guessIndentation(lines: string[]): number;
...
declare namespace ts {
    const Diagnostics: {
        ...
        Add_this_to_all_unresolved_variables_matching_a_member_name: DiagnosticMessage;
...
declare namespace ts {
    ...
    function createExpressionForJsxElement(jsxFactoryEntity: EntityName, reactNamespace: string, tagName: Expression, props: Expression, children: ReadonlyArray<Expression>, parentElement: JsxOpeningLikeElement, location: TextRange): LeftHandSideExpression;
    function createExpressionForJsxFragment(jsxFactoryEntity: EntityName, reactNamespace: string, children: ReadonlyArray<Expression>, parentElement: JsxOpeningFragment, location: TextRange): LeftHandSideExpression;
...
declare namespace ts {
    ...
    function createGetSymbolAccessibilityDiagnosticForNodeName(node: DeclarationDiagnosticProducing): (symbolAccessibilityResult: SymbolAccessibilityResult) => SymbolAccessibilityDiagnostic;
    function createGetSymbolAccessibilityDiagnosticForNode(node: DeclarationDiagnosticProducing): (symbolAccessibilityResult: SymbolAccessibilityResult) => SymbolAccessibilityDiagnostic;
}
declare namespace ts {
    function getDeclarationDiagnostics(host: EmitHost, resolver: EmitResolver, file: SourceFile | undefined): Diagnostic[];
    /**
...
declare namespace ts {
     ...
     */
    function forEachEmittedFile<T>(host: EmitHost, action: (emitFileNames: EmitFileNames, sourceFileOrBundle: SourceFile | Bundle) => T, sourceFilesOrTargetSourceFile?: ReadonlyArray<SourceFile> | SourceFile, emitOnlyDtsFiles?: boolean): T;
    function getOutputPathsFor(sourceFile: SourceFile | Bundle, host: EmitHost, forceDtsPaths: boolean): {
        jsFilePath: string;
        sourceMapFilePath: string;
...
declare namespace ts {
    ...
    function isInString(sourceFile: SourceFile, position: number, previousToken?: Node): boolean;
    /**
...
declare namespace ts.Completions {
    ...
    function getCompletionsAtPosition(host: LanguageServiceHost, program: Program, log: Log, sourceFile: SourceFile, position: number, preferences: UserPreferences): CompletionInfo | undefined;
    interface CompletionEntryIdentifier {
        name: string;
        source?: string;
    }
    function getCompletionEntryDetails(program: Program, log: Log, sourceFile: SourceFile, position: number, entryId: CompletionEntryIdentifier, host: LanguageServiceHost, formatContext: formatting.FormatContext, getCanonicalFileName: GetCanonicalFileName, preferences: UserPreferences): CompletionEntryDetails;
...
declare namespace ts {
    function computeSuggestionDiagnostics(sourceFile: SourceFile, program: Program): Diagnostic[];
}
declare namespace ts.SymbolDisplay {
    ...
    function getSymbolDisplayPartsDocumentationAndSymbolKind(typeChecker: TypeChecker, symbol: Symbol, sourceFile: SourceFile, enclosingDeclaration: Node, location: Node, semanticMeaning?: SemanticMeaning, alias?: Symbol): SymbolDisplayPartsDocumentationAndSymbolKind;
}
declare namespace ts {
...
declare namespace ts {
    ...
    namespace codefix {
        ...
        function createCodeFixActionNoFixId(changes: FileTextChanges[], description: DiagnosticAndArguments): CodeFixAction;
        function createCodeFixAction(changes: FileTextChanges[], description: DiagnosticAndArguments, fixId: {}, fixAllDescription: DiagnosticAndArguments, command?: CodeActionCommand): CodeFixAction;
...
declare namespace ts.codefix {
    ...
    function createMethodFromCallExpression({ typeArguments, arguments: args }: CallExpression, methodName: string, inJs: boolean, makeStatic: boolean, preferences: UserPreferences): MethodDeclaration;
}
declare namespace ts.codefix {
}
declare namespace ts.codefix {
